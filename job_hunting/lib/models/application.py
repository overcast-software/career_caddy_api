...
class Application(BaseModel):
    ...
    job_post_id = Column(Integer, ForeignKey("job_post.id", ondelete="SET NULL"), nullable=True)
    resume_id = Column(Integer, ForeignKey("resume.id", ondelete="SET NULL"))
    cover_letter_id = Column(Integer, ForeignKey("cover_letter.id", ondelete="SET NULL"))
